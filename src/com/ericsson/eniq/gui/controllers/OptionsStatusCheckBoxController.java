...
public class OptionsStatusCheckBoxController implements EventHandler<ActionEvent> {
    ...
    public void handle(ActionEvent event) {
        ...
        if (text.equals(ParserOptions.CB_SELECT_ALL)) {
            SelectedParserOptions.getInstance().selectAllStatus(isSelected);
            //
            ...
            SelectedParserOptions.getInstance().addStatusOption(text, isSelected);
        }
    }
